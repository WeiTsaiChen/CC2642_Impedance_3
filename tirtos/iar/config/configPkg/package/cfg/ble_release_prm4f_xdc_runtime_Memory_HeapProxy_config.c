...
/* DELEGATES TO ti.sysbios.heaps.HeapCallback */

/* Module__startupDone__S */
xdc_Bool xdc_runtime_Memory_HeapProxy_Module__startupDone__S( void ) 
{
    return ti_sysbios_heaps_HeapCallback_Module__startupDone__S();
}
...
{
    return (xdc_runtime_Memory_HeapProxy_Handle)ti_sysbios_heaps_HeapCallback_create((const ti_sysbios_heaps_HeapCallback_Params *)prms, eb);
}
...
{
    ti_sysbios_heaps_HeapCallback_Params__init__S(dst, src, psz, isz);
}

/* Handle__label__S */
xdc_runtime_Types_Label *xdc_runtime_Memory_HeapProxy_Handle__label__S(xdc_Ptr obj, xdc_runtime_Types_Label *lab)
{
    return ti_sysbios_heaps_HeapCallback_Handle__label__S(obj, lab);
}
...
{
    return (const void *)&ti_sysbios_heaps_HeapCallback_Module__FXNS__C;
}
